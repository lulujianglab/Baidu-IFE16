...
function renderChart() {
    ...
    var now_select_city = pageState["nowSelectCity"]; //当前城市
...
function initCitySelector() {
    ...
    for (var city in aqiSourceData) {
        value += "<option>" + city + "</option>";
    }
    document.getElementById('city-select').innerHTML = value;
...
function initAqiChartData() {
    ...
    for (var city in aqiSourceData) {//city是城市
        ...
        for (var date in aqiSourceData[city]) {
            // 再次遍历，把每个城市对应的数据挑出来，data是每一天的日期
